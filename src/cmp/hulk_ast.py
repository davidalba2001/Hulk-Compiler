...
class CallableNode(Node):
    def __init__(
        self, identifier, params, type_annotation, body, line=None, ntype="CALLABLE"
    ):
        super().__init__(line, ntype)
...
class FuncNode(CallableNode, StatementNode):
    def __init__(
        self, identifier, params, type_annotation, body, line=None, ntype="FUNCTION"
    ):
        CallableNode.__init__(
            self, identifier, params, type_annotation, body, line, ntype
        )
...
class MethodNode(CallableNode):
    def __init__(
        self, identifier, params, type_annotation, body, line=None, ntype="METHOD"
    ):
...
class MethodCallNode(CallNode):
    def __init__(
        self, type_identifier, identifier, arguments, line=None, ntype="METHOD_CALL"
    ):
        super().__init__(identifier, arguments, line, ntype)
...
class ImplicitVectorNode(TypeInstanceNode):
    def __init__(
        self, expression, identifier, iterable, line=None, ntype="IMPLICIT_VECTOR"
    ):
        super().__init__(line, ntype)
        self.expression = expression
        self.identifier = identifier
...
class AssignmentNode(BindingNode):
    def __init__(
        self, identifier, type_annotation, expression, line=None, ntype="ASSIGNMENT"
    ):
